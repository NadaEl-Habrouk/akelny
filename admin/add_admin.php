    ...
    <div class="container">
            ...
            if (count($errors)>0){
              foreach($errors as $errors){
                echo  "<div class='alert alert-danger'>$errors</div>";
                 ...
                 $sql= "INSERT INTO user(fname, lname, email, password, phone, is_admin, gender) VALUES ('$firstname','$lastname','$email','$password','$phone',true,'$Gender')";
      ...
      <form  method="post">
        ...
        <div class="form-submit-btn">
          <input type="submit" value="Add Admin" name="create">
        </div>
